...
import com.app.edtech.model.CreatorsBenefitsResponse
import com.app.edtech.model.SendOtpPhoneRequest
...
interface ApiService {
    ...
    suspend fun getOtherUserProfile(@Header("Authorization") token: String, @Path("userId") userId:String,  @Query("page") page: String? = null,
                                    @Query("limit") limit: String? = null): GetProfileResponse
